...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask0 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask0.7 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask0.8 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask12 (void) {
  ...
  SetEvent(CPU1Task1Subtask7,EVENT3);
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task3Subtask12.8 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask2 (void) {
  ...
  SetEvent(CPU0Task0Subtask0,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU1Task5Subtask10 (void) {
  ...
  ara_timing_info(13, 36); // 0
  SetEvent(CPU0Task0Subtask6,EVENT2);
