...
void AUTOSAR_TASK_FUNC_CPU0Task4Subtask10 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask10.7 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(1, 13); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask10.6 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(15, 46); // 0
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask10.8 sys_allowed=True inside_critical=False> x*/
