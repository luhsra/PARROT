...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask9 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask9.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask9.7 sys_allowed=True inside_critical=False> x*/
