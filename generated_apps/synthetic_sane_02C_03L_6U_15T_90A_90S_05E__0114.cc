...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask0 (void) {
  ...
  SetEvent(CPU0Task0Subtask3,EVENT1);
...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask10 (void) {
  ...
  SetEvent(CPU0Task0Subtask12,EVENT4);
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task3Subtask10.5 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(8, 15); // 1
  ReleaseSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task3Subtask10.6 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(4, 162); // 0
  TerminateTask();
