...
void AUTOSAR_TASK_FUNC_CPU2Task4Subtask13 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask13.6 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(10, 12); // 1
  ReleaseSpinlock(LOCK1);
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask13.7 sys_allowed=True inside_critical=False> x*/
