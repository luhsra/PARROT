...
void AUTOSAR_TASK_FUNC_CPU3Task4Subtask2 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask2.4 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task0Subtask13 (void) {
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task0Subtask13.5 sys_allowed=True inside_critical=False> x*/
