...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask4 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask4.7 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask4.8 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask4.9 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask6 (void) {
  ...
  SetEvent(CPU0Task1Subtask4,EVENT1);
...
void AUTOSAR_TASK_FUNC_CPU1Task0Subtask2 (void) {
  ...
  SetEvent(CPU1Task3Subtask3,EVENT2);
  ...
  ReleaseSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task0Subtask2.7 sys_allowed=True inside_critical=False> x*/
