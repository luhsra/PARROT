...
void AUTOSAR_TASK_FUNC_CPU1Task5Subtask6 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task5Subtask6.6 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task5Subtask6.5 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(2, 4); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task5Subtask6.7 sys_allowed=True inside_critical=False> x*/
