...
void AUTOSAR_TASK_FUNC_CPU5Task4Subtask10 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task4Subtask10.3 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(8, 15); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task4Subtask10.4 sys_allowed=True inside_critical=False> x*/
