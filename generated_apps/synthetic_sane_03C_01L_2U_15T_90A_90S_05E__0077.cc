...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask1 (void) {
  ...
  SetEvent(CPU2Task3Subtask0,EVENT4);
...
void AUTOSAR_TASK_FUNC_CPU2Task4Subtask5 (void) {
  ...
  SetEvent(CPU2Task3Subtask8,EVENT3);
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask5.4 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(7, 19); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask5.5 sys_allowed=True inside_critical=False> x*/
