...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask1 (void) {
  ...
  SetEvent(CPU0Task3Subtask10,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask11 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask11.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask11.7 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask7 (void) {
  ...
  SetEvent(CPU0Task0Subtask12,EVENT2);
