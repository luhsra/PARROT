...
void AUTOSAR_TASK_FUNC_CPU0Task2Subtask5 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task2Subtask5.7 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task2Subtask5.8 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task2Subtask5.9 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(3, 28); // 1
  ReleaseSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task2Subtask5.6 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(5, 164); // 0
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task2Subtask5.10 sys_allowed=True inside_critical=False> x*/
