...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask4 (void) {
  ...
  ara_timing_info(13, 105); // 0
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask4.7 sys_allowed=True inside_critical=False> x*/
