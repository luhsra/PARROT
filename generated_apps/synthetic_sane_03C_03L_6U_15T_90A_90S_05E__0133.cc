...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask2 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask2.8 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask2.9 sys_allowed=True inside_critical=False> x*/
