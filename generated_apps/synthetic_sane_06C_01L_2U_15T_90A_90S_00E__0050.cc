...
void AUTOSAR_TASK_FUNC_CPU3Task2Subtask3 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task2Subtask3.4 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task2Subtask3.5 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU5Task5Subtask14 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task5Subtask14.4 sys_allowed=False inside_critical=True> x*/
