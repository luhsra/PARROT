...
void AUTOSAR_TASK_FUNC_CPU2Task5Subtask11 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task5Subtask11.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task5Subtask11.7 sys_allowed=True inside_critical=False> x*/
