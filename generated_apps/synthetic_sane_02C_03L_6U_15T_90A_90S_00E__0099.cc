...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask7 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task2Subtask7.3 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task5Subtask5 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task5Subtask5.4 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(9, 28); // 1
  ReleaseSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task5Subtask5.5 sys_allowed=True inside_critical=False> x*/
