...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask12 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask12.5 sys_allowed=False inside_critical=True> x*/
  ...
  SetEvent(CPU1Task2Subtask14,EVENT1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask12.4 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(5, 7); // 0
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask12.6 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask8 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask8.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask8.7 sys_allowed=True inside_critical=False> x*/
