...
void AUTOSAR_TASK_FUNC_CPU0Task2Subtask7 (void) {
  ...
  SetEvent(CPU2Task5Subtask4,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU2Task5Subtask4 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task5Subtask4.4 sys_allowed=False inside_critical=True> x*/
  ...
  WaitEvent(EVENT0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task5Subtask4.5 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task5Subtask8 (void) {
  ...
  SetEvent(CPU1Task3Subtask10,EVENT1);
