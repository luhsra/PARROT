...
void AUTOSAR_TASK_FUNC_CPU3Task0Subtask1 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task0Subtask1.3 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(2, 11); // 1
  ReleaseSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task0Subtask1.4 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task1Subtask4 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task1Subtask4.7 sys_allowed=False inside_critical=True> x*/
  ...
  ActivateTask(CPU4Task1Subtask9);
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task1Subtask4.8 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU5Task2Subtask7 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task2Subtask7.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task2Subtask7.6 sys_allowed=True inside_critical=False> x*/
