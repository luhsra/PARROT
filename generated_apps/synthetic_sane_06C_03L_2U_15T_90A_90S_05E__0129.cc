...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask12 (void) {
  ...
  SetEvent(CPU2Task3Subtask14,EVENT1);
...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask2 (void) {
  ...
  SetEvent(CPU1Task4Subtask4,EVENT4);
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask13 (void) {
  ...
  SetEvent(CPU4Task2Subtask9,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask6 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask6.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask6.6 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task2Subtask11 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task2Subtask11.4 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(8, 9); // 1
  ReleaseSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task2Subtask11.5 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU5Task5Subtask5 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task5Subtask5.3 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(1, 21); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task5Subtask5.4 sys_allowed=True inside_critical=False> x*/
