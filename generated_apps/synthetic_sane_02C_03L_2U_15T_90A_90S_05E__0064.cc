...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask11 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask11.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask11.7 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask2 (void) {
  ...
  SetEvent(CPU0Task0Subtask14,EVENT1);
