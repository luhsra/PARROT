...
void AUTOSAR_TASK_FUNC_CPU3Task0Subtask13 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task0Subtask13.3 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task0Subtask13.4 sys_allowed=True inside_critical=False> x*/
