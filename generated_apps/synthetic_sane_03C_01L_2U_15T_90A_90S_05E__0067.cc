...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask5 (void) {
  ...
  SetEvent(CPU2Task4Subtask6,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU2Task4Subtask9 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask9.4 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(3, 30); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask9.5 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task5Subtask3 (void) {
  ...
  SetEvent(CPU0Task1Subtask8,EVENT3);
