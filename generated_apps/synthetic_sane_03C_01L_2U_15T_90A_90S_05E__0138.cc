...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask12 (void) {
  ...
  SetEvent(CPU0Task0Subtask5,EVENT3);
  ...
  SetEvent(CPU1Task2Subtask9,EVENT1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task3Subtask12.5 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(10, 87); // 0
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task3Subtask12.7 sys_allowed=False inside_critical=True> x*/
