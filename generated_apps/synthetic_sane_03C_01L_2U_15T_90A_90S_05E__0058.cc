...
void AUTOSAR_TASK_FUNC_CPU0Task5Subtask5 (void) {
  ...
  SetEvent(CPU2Task4Subtask3,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU2Task0Subtask4 (void) {
  ...
  SetEvent(CPU2Task4Subtask13,EVENT2);
...
void AUTOSAR_TASK_FUNC_CPU2Task4Subtask9 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask9.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask9.6 sys_allowed=True inside_critical=False> x*/
