...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask10 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask10.6 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(10, 20); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask10.7 sys_allowed=True inside_critical=False> x*/
