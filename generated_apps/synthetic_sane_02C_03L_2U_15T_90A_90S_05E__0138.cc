...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask10 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask10.7 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask10.8 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask1 (void) {
  ...
  SetEvent(CPU1Task2Subtask13,EVENT0);
