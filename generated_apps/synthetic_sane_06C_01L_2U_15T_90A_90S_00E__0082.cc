...
void AUTOSAR_TASK_FUNC_CPU4Task1Subtask11 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task1Subtask11.4 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task1Subtask11.5 sys_allowed=True inside_critical=False> x*/
