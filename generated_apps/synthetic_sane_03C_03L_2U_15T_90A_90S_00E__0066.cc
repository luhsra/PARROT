...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask9 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task2Subtask9.3 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task3Subtask11 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task3Subtask11.5 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(4, 14); // 1
  ReleaseSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task3Subtask11.6 sys_allowed=True inside_critical=False> x*/
