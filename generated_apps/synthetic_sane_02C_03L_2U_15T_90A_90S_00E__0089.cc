...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask14 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask14.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask14.7 sys_allowed=True inside_critical=False> x*/
