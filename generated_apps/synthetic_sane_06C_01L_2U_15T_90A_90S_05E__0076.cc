...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask14 (void) {
  ...
  SetEvent(CPU5Task5Subtask6,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask9 (void) {
  ...
  SetEvent(CPU0Task3Subtask11,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU2Task1Subtask2 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task1Subtask2.4 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task0Subtask12 (void) {
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task0Subtask12.3 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(16, 52); // 0
  SetEvent(CPU1Task2Subtask3,EVENT1);
