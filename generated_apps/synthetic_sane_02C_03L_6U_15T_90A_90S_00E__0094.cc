...
void AUTOSAR_TASK_FUNC_CPU0Task5Subtask9 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask9.9 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask9.8 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask9.10 sys_allowed=True inside_critical=False> x*/
