...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask13 (void) {
  ...
  SetEvent(CPU0Task5Subtask11,EVENT1);
...
void AUTOSAR_TASK_FUNC_CPU0Task5Subtask11 (void) {
  ...
  SetEvent(CPU0Task2Subtask6,EVENT2);
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask11.7 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask14 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask14.4 sys_allowed=False inside_critical=True> x*/
