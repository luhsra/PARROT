...
void AUTOSAR_TASK_FUNC_CPU2Task0Subtask6 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task0Subtask6.6 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(7, 18); // 1
  ReleaseSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task0Subtask6.7 sys_allowed=True inside_critical=False> x*/
