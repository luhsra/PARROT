...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask7 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask7.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask7.6 sys_allowed=True inside_critical=False> x*/
