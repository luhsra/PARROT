...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask1 (void) {
  ...
  SetEvent(CPU0Task3Subtask4,EVENT2);
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask1.7 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask1.8 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask12 (void) {
  ...
  SetEvent(CPU0Task0Subtask14,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU2Task1Subtask10 (void) {
  ...
  SetEvent(CPU0Task4Subtask9,EVENT4);
