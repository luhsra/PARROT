...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask0 (void) {
  ...
  SetEvent(CPU1Task2Subtask5,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU2Task0Subtask11 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task0Subtask11.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task0Subtask11.6 sys_allowed=True inside_critical=False> x*/
