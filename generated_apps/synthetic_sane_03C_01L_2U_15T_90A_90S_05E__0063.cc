...
void AUTOSAR_TASK_FUNC_CPU0Task2Subtask11 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task2Subtask11.5 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask13 (void) {
  ...
  SetEvent(CPU2Task5Subtask1,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask4 (void) {
  ...
  SetEvent(CPU1Task3Subtask13,EVENT4);
...
void AUTOSAR_TASK_FUNC_CPU2Task0Subtask9 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task0Subtask9.4 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task1Subtask0 (void) {
  ...
  SetEvent(CPU2Task5Subtask3,EVENT3);
