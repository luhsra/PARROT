...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask7 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask7.4 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task5Subtask12 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task5Subtask12.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task5Subtask12.6 sys_allowed=True inside_critical=False> x*/
