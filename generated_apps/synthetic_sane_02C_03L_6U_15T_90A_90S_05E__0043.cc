...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask5 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask5.7 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask5.9 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask5.8 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask5.10 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask3 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask3.8 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask3.6 sys_allowed=True inside_critical=False> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask3.9 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask9 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask9.4 sys_allowed=False inside_critical=True> x*/
