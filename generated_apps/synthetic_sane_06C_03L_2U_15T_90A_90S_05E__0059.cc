...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask12 (void) {
  ...
  SetEvent(CPU3Task4Subtask5,EVENT4);
...
void AUTOSAR_TASK_FUNC_CPU3Task4Subtask14 (void) {
  ...
  SetEvent(CPU0Task1Subtask12,EVENT1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask14.3 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(5, 34); // 0
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask14.4 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(8, 75); // 0
  SetEvent(CPU4Task0Subtask10,EVENT2);
...
void AUTOSAR_TASK_FUNC_CPU3Task4Subtask2 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask2.8 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(8, 24); // 1
  ReleaseSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask2.5 sys_allowed=True inside_critical=False> x*/
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask2.7 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(1, 7); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask2.9 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task0Subtask0 (void) {
  ...
  SetEvent(CPU3Task4Subtask8,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU4Task0Subtask10 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task0Subtask10.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task0Subtask10.6 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task0Subtask13 (void) {
  ...
  SetEvent(CPU3Task4Subtask3,EVENT0);
