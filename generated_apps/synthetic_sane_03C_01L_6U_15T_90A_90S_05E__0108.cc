...
void AUTOSAR_TASK_FUNC_CPU2Task2Subtask2 (void) {
  ...
  ara_timing_info(10, 124); // 0
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task2Subtask2.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task2Subtask2.7 sys_allowed=True inside_critical=False> x*/
