...
void AUTOSAR_TASK_FUNC_CPU0Task4Subtask1 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask1.6 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task0Subtask9 (void) {
  ...
  SetEvent(CPU1Task2Subtask6,EVENT3);
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task0Subtask9.6 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task0Subtask9.5 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(6, 13); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task0Subtask9.7 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask8 (void) {
  ...
  SetEvent(CPU1Task2Subtask13,EVENT1);
...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask5 (void) {
  ...
  SetEvent(CPU1Task2Subtask8,EVENT0);
