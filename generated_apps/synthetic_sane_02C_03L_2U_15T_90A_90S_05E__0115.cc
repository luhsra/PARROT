...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask5 (void) {
  ...
  SetEvent(CPU1Task2Subtask10,EVENT4);
...
void AUTOSAR_TASK_FUNC_CPU1Task0Subtask8 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task0Subtask8.3 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask14 (void) {
  ...
  SetEvent(CPU1Task2Subtask4,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask4 (void) {
  ...
  SetEvent(CPU1Task5Subtask9,EVENT0);
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask1 (void) {
  ...
  SetEvent(CPU1Task2Subtask2,EVENT2);
