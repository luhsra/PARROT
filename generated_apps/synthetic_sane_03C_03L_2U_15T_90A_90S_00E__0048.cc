...
void AUTOSAR_TASK_FUNC_CPU0Task2Subtask3 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task2Subtask3.4 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(1, 28); // 1
  ReleaseSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task2Subtask3.5 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(3, 64); // 0
  TerminateTask();
...
void AUTOSAR_TASK_FUNC_CPU2Task4Subtask11 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask11.5 sys_allowed=False inside_critical=True> x*/
  ...
  ReleaseSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task4Subtask11.6 sys_allowed=True inside_critical=False> x*/
