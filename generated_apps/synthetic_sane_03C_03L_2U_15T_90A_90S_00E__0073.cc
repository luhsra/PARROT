...
void AUTOSAR_TASK_FUNC_CPU0Task4Subtask8 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask8.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask8.7 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task1Subtask0 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task1Subtask0.3 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task1Subtask0.4 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task1Subtask4 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task1Subtask4.5 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(4, 8); // 1
  ReleaseSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task1Subtask4.6 sys_allowed=True inside_critical=False> x*/
