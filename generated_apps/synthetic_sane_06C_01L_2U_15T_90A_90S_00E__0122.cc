...
noinline EXTERN_C_DECL void AUTOSAR_TASK_FUNC_CPU4Task5Subtask4 (void);
...
void AUTOSAR_TASK_FUNC_CPU1Task0Subtask2 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task0Subtask2.3 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU3Task4Subtask13 (void) {
  ...
  ActivateTask(CPU3Task4Subtask9);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask13.2 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(1, 102); // 0
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU3Task4Subtask13.3 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task5Subtask4 (void) {
  // kout << "AUTOSAR_TASK_FUNC_CPU4Task5Subtask4" << endl;
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task5Subtask4.0 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(2, 129); // 0
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task5Subtask4.1 sys_allowed=True inside_critical=False> x*/
  ara_timing_info(4, 66); // 0
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task5Subtask4.2 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task5Subtask5 (void) {
  ...
  ActivateTask(CPU4Task5Subtask4);
...
void AUTOSAR_TASK_FUNC_CPU5Task3Subtask11 (void) {
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task3Subtask11.3 sys_allowed=True inside_critical=False> x*/
