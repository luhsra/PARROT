...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask11 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask11.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask11.7 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask10 (void) {
  ...
  SetEvent(CPU1Task5Subtask14,EVENT4);
...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask6 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask6.4 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU0Task2Subtask4 (void) {
  ...
  SetEvent(CPU0Task0Subtask9,EVENT2);
