...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask1 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask1.7 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask1.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask1.8 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask9 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task3Subtask9.5 sys_allowed=False inside_critical=True> x*/
  ...
  SetEvent(CPU0Task5Subtask7,EVENT2);
...
void AUTOSAR_TASK_FUNC_CPU0Task5Subtask7 (void) {
  ...
  SetEvent(CPU0Task3Subtask1,EVENT4);
...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask2 (void) {
  ...
  SetEvent(CPU1Task2Subtask3,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask8 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask8.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask8.6 sys_allowed=True inside_critical=False> x*/
