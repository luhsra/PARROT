...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask3 (void) {
  ...
  SetEvent(CPU1Task4Subtask2,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU2Task2Subtask8 (void) {
  ...
  SetEvent(CPU2Task3Subtask9,EVENT4);
...
void AUTOSAR_TASK_FUNC_CPU2Task3Subtask14 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task3Subtask14.5 sys_allowed=False inside_critical=True> x*/
