...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask6 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task2Subtask6.6 sys_allowed=False inside_critical=True> x*/
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task2Subtask6.7 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task2Subtask6.8 sys_allowed=True inside_critical=False> x*/
