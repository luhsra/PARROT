...
void AUTOSAR_TASK_FUNC_CPU1Task0Subtask1 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task0Subtask1.3 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU4Task4Subtask14 (void) {
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU4Task4Subtask14.3 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU5Task1Subtask5 (void) {
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task1Subtask5.3 sys_allowed=True inside_critical=False> x*/
