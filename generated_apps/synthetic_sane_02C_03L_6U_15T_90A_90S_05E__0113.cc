...
void AUTOSAR_TASK_FUNC_CPU0Task5Subtask3 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask3.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask3.6 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask0 (void) {
  ...
  SetEvent(CPU1Task0Subtask5,EVENT1);
...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask13 (void) {
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask13.6 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask1 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask1.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask1.7 sys_allowed=True inside_critical=False> x*/
