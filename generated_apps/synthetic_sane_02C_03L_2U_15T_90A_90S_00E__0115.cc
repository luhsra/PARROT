...
void AUTOSAR_TASK_FUNC_CPU0Task1Subtask5 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask5.8 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(5, 10); // 1
  ReleaseSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task1Subtask5.9 sys_allowed=True inside_critical=False> x*/
