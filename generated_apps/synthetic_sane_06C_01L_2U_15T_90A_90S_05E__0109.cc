...
void AUTOSAR_TASK_FUNC_CPU2Task0Subtask0 (void) {
  ...
  SetEvent(CPU0Task2Subtask3,EVENT1);
...
void AUTOSAR_TASK_FUNC_CPU2Task0Subtask13 (void) {
  ...
  SetEvent(CPU5Task4Subtask6,EVENT2);
  ...
  SetEvent(CPU2Task0Subtask0,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU5Task4Subtask11 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU5Task4Subtask11.3 sys_allowed=False inside_critical=True> x*/
