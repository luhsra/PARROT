...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask10 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task3Subtask10.6 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task3Subtask10.7 sys_allowed=True inside_critical=False> x*/
