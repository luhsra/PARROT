...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask8 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask8.3 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task2Subtask12 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task2Subtask12.4 sys_allowed=False inside_critical=True> x*/
