...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask2 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask2.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task4Subtask2.6 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task1Subtask1 (void) {
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task1Subtask1.5 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task2Subtask9 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task2Subtask9.4 sys_allowed=False inside_critical=True> x*/
