...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask6 (void) {
  ...
  ara_timing_info(16, 25); // 0
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask6.3 sys_allowed=False inside_critical=True> x*/
