...
void AUTOSAR_TASK_FUNC_CPU0Task4Subtask6 (void) {
  ...
  GetSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask6.6 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(5, 28); // 1
  ReleaseSpinlock(LOCK2);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask6.7 sys_allowed=True inside_critical=False> x*/
