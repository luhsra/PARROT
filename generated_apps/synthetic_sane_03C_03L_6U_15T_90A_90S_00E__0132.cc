...
void AUTOSAR_TASK_FUNC_CPU1Task0Subtask14 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task0Subtask14.3 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU2Task5Subtask9 (void) {
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU2Task5Subtask9.6 sys_allowed=True inside_critical=False> x*/
