...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask14 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask14.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask14.6 sys_allowed=True inside_critical=False> x*/
