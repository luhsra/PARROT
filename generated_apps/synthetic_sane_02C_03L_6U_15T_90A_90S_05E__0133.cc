...
void AUTOSAR_TASK_FUNC_CPU0Task5Subtask0 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask0.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task5Subtask0.6 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task1Subtask12 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask12.5 sys_allowed=False inside_critical=True> x*/
  ara_timing_info(7, 7); // 1
  ReleaseSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU1Task1Subtask12.6 sys_allowed=True inside_critical=False> x*/
...
void AUTOSAR_TASK_FUNC_CPU1Task2Subtask9 (void) {
  ...
  SetEvent(CPU0Task5Subtask8,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU1Task3Subtask14 (void) {
  ...
  SetEvent(CPU1Task4Subtask7,EVENT1);
...
void AUTOSAR_TASK_FUNC_CPU1Task4Subtask4 (void) {
  ...
  SetEvent(CPU1Task1Subtask1,EVENT2);
