...
void AUTOSAR_TASK_FUNC_CPU0Task0Subtask8 (void) {
  ...
  GetSpinlock(LOCK1);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task0Subtask8.3 sys_allowed=False inside_critical=True> x*/
...
void AUTOSAR_TASK_FUNC_CPU0Task3Subtask3 (void) {
  ...
  SetEvent(CPU0Task0Subtask6,EVENT3);
...
void AUTOSAR_TASK_FUNC_CPU0Task4Subtask7 (void) {
  ...
  GetSpinlock(LOCK0);
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask7.5 sys_allowed=False inside_critical=True> x*/
  ...
  /* <InsertionPoint AUTOSAR_TASK_FUNC_CPU0Task4Subtask7.6 sys_allowed=True inside_critical=False> x*/
